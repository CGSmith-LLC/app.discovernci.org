const locations = [
  { id: 1,
    ...
    type: 'ee',
    primaryContacts: [7],
    bannerImg: '//nciw.s3.amazonaws.com/discovernci_media/AngelusOaksPano.jpg',
    bgImg: 'https://nciw.s3.amazonaws.com/discovernci_media/AngelusOaksBg.jpg',
    ogImg: '//nciw.s3.amazonaws.com/discovernci_media/nci-og-angelus-oaks.jpg',
    ogDescription: 'Escape the valley and experience a true environmental program where students have the opportunity to explore this spectacular environment. “A true mountain experience” Located with easy accessibility of LA and San Diego and surrounds.',
    foodMenu: '',
    facebookUrl: 'https://www.facebook.com/NaturesClassroomInstituteWI/',
    sidebarContent: '',
    streetAddress: '42900 Jenks Lake Road<br /> Angelus Oaks, CA 92305',
    phone: '310-892-9468',
    body: '<p>Nature’s Classroom Institute Mountain site is in the San Bernardino Mountains at Angelus Oaks. Just above the South Fork Santa Ana River NCI Angelus Oaks offers mountain hiking trails, alpine forests, river exploration and full access to the spectacular Jenks Lake. NCI Angelus Oaks has fully winterized cabins, large dining room and break out spots set with in the backdrop of the San Bernardino Mountains. Escape the valley and experience a true environmental program where students have the opportunity to explore this spectacular environment. “A true mountain experience” Located with easy accessibility of LA and San Diego and surrounds.</p> <img src="//nciw.s3.amazonaws.com/discovernci_media/AngelusOaksCalifornia-Jenks-Lake.jpg" class="img-responsive img-rounded" alt="" />',
    openEnrollment: false,
    sidebarGeneralInfo: [
      { rank: 0, title: 'Angelus Oaks Fact Sheet (PDF)', url: 'https://nciw.s3.amazonaws.com/documents/NCI_AngelusOaks.pdf', faName: 'file-pdf-o' },
      { rank: 1 },
      { rank: 2, title: 'Prepare for NCI', to: '/environmental/prepare', faName: 'check-square-o' },
      { rank: 3, title: 'Registration Portal', url: 'https://discovernci.org/dashboard', faName: 'clipboard' },
      { rank: 4, title: 'NCI Facebook Page', url: 'https://www.facebook.com/NaturesClassroomInstitute/', faName: 'facebook-official' },
      { rank: 5 },
      { rank: 6, title: 'Faculty & Staff', to: '/environmental/angelus-oaks-california/faculty-staff', faName: 'users' }
    ]
  },
  { id: 2,
    ...
    type: 'ee',
    primaryContacts: [7],
    bannerImg: '//nciw.s3.amazonaws.com/discovernci_media/NapaPano.jpg',
    bgImg: 'https://nciw.s3.amazonaws.com/discovernci_media/NapaCaliforniaBg3.jpg',
    ogImg: '//nciw.s3.amazonaws.com/discovernci_media/nci-og-ben-lomond-california.jpg',
    ogDescription: 'Nestled among giant, ancient Redwoods on the banks of Mason Creek and the San Lorenzo River, sits our new NCI site in Ben Lomond, CA. From the full glass dining room, to the classroom in the tree house, your students will experience some of nature’s greatest wonders.',
    foodMenu: '',
    sidebarContent: '<img src="//nciw.s3.amazonaws.com/discovernci_media/Ben%20Lomond%203.JPG" class="img-responsive img-rounded bottom-30" alt="presentation">',
    streetAddress: '7795 Hwy 9<br /> Ben Lomond, CA 95018',
    phone: '310-892-9468',
    body: '<p>Nestled among giant, ancient Redwoods on the banks of Mason Creek and the San Lorenzo River, sits our new NCI site in Ben Lomond, CA. From the full glass dining room, to the classroom in the tree house, your students will experience some of nature’s greatest wonders. Situated on nearly 100 acres of mountainous terrain, with covered pathways that pass some of nature’s great standards, students will discover banana slugs to foxes as they explore the myriad of trails. We are excited to offer this new Northern California location as part of the amazing natural facilities that Nature’s Classroom Institute uses.</p> <img src="//nciw.s3.amazonaws.com/discovernci_media/Ben%20Lomond.jpg" class="img-responsive img-rounded" alt="" /> <br /> <img src="//nciw.s3.amazonaws.com/discovernci_media/Ben%20Lomond%202.JPG" class="img-responsive img-rounded" />',
    openEnrollment: false,
    sidebarGeneralInfo: [
      { rank: 0, title: 'Fact Sheet TBA', faName: 'file-pdf-o' },
      { rank: 1 },
      { rank: 2, title: 'Prepare for NCI', to: '/environmental/prepare', faName: 'check-square-o' },
      { rank: 3, title: 'Registration Portal', url: 'https://discovernci.org/dashboard', faName: 'clipboard' },
      { rank: 4, title: 'NCI Facebook Page', url: 'https://www.facebook.com/NaturesClassroomInstitute/', faName: 'facebook-official' },
      { rank: 5 },
      { rank: 6, title: 'Faculty & Staff', to: '/environmental/ben-lomond-california/faculty-staff', faName: 'users' }
    ],
    specialMsg: ''
  },
  { id: 3,
    ...
    type: 'ee',
    primaryContacts: [7],
    bannerImg: '//nciw.s3.amazonaws.com/discovernci_media/BrucevilleTexas-Collage.jpg',
    bgImg: 'https://nciw.s3.amazonaws.com/discovernci_media/BrucevilleTexasBg.jpg',
    ogImg: '',
    ogDescription: "Brucevlle's natural setting provides participants the ideal combination of beauty and charm. Memorable moments, our modern facility, and a multitude of activities make Nature's Classroom in Bruceville far more than the usual retreat experience.",
    foodMenu: '',
    sidebarContent: '',
    streetAddress: '1192 Smith Lane<br /> Bruceville, TX 76630',
    phone: '310-892-9468',
    body: "<p>Located in Central Texas, Nature's Classroom Institute in Bruceville is close to most major Texas cities including Dallas, Fort Worth, Austin, and Houston.</p> <p>Nature's Classroom Institute in Brucevlle's natural setting provides participants the ideal combination of beauty and charm. Here on our 300 acres, nature, people and environment, are in tune with one another. Memorable moments, our modern facility, and a multitude of activities make Nature's Classroom in Bruceville far more than the usual retreat experience. Once a guest in Bruceville, you will want to make this special place your second home!</p> <p>Bruceville has hosted hundreds of retreats over the past 30 years for team building, outdoor education, staff training, spiritual exploration, youth programs, sports teams, universities, social and family gatherings as well as corporate conferences and other outings.</p> <img src=\"//nciw.s3.amazonaws.com/discovernci_media/BrucevilleTexas-EcoVillage-Collage.jpg\" class=\"img-responsive\" /> <h2>EcoVillage</h2> <p>The EcoVillage sits in the woodlands of nearly 290 acres adjacent to a zoo and vegetable garden. The goal of the EcoVillage is to introduce teenagers to the natural world and to help them understand and appreciate their role in the eco-system.</p> <p>There are four monolithic domes that can house up to 72 people and a kitchen and dining room powered by solar cells. The photovoltaic cells will help provide electiricty - off the grid - for lights, utilities and air conditioning throughout the eco-village. The water is from passive solar hot water heaters to make students aware of the energy they use and allow them to control the way they use their resources.</p> <p>The power of choice with immediate results is a powerful learning tool built into the curriculum of the entire program and with the EcoVillage students will feel more empowered than ever!</p>",
    openEnrollment: false,
    sidebarGeneralInfo: [
      { rank: 0, title: 'Bruceville Fact Sheet (PDF)', url: 'https://nciw.s3.amazonaws.com/documents/NCI_Bruceville_FactSheet.pdf', faName: 'file-pdf-o' },
      { rank: 1, title: 'Bruceville Room Assignment (.xlsx)', url: 'http://nciw.s3.amazonaws.com/documents/Bruceville-Housing-Assignment-Worksheet.xlsx', faName: 'file-pdf-o' },
      { rank: 2 },
      { rank: 3, title: 'Prepare for NCI', to: '/environmental/prepare', faName: 'check-square-o' },
      { rank: 4, title: 'Registration Portal', url: 'https://discovernci.org/dashboard', faName: 'clipboard' },
      { rank: 5, title: 'NCI Facebook Page', url: 'https://www.facebook.com/NaturesClassroomInstitute/', faName: 'facebook-official' },
      { rank: 6 },
      { rank: 7, title: 'Faculty & Staff', to: '/environmental/bruceville-texas/faculty-staff', faName: 'users' }
    ]
  },
  { id: 4,
    name: 'New Ulm, Texas',
    ...
    type: 'ee',
    primaryContacts: [7],
    bannerImg: '//nciw.s3.amazonaws.com/discovernci_media/WimberleyTexasCollage.jpg',
    bgImg: 'https://nciw.s3.amazonaws.com/discovernci_media/newulm-bg.jpg',
    ogImg: '',
    ogDescription: 'The camp like atmosphere accommodates housing for up to 85 students, comfortable sleeping quarters, ample bathroom facilities, and a modern retreat center. The New Ulm site is surrounded by 240 acres of rolling terrain, a 5 acre lake, a wealth of oak trees, and dawn-grazing deer.',
    foodMenu: '',
    sidebarContent: '',
    streetAddress: '1912 Zimmerscheidt Rd<br /> New Ulm, TX 78950',
    phone: '310-892-9468',
    body: '<p>Nestled in South Central Texas among the wooded rolling countryside, sits our new NCI site in New Ulm, TX. From the new dorm rooms, to the lake and large outdoor activity spaces, your students will experience the ideal combination of beauty and charm. Situated on over 200 acres, students will experience how nature, people and the environment are in tune with one another. We are excited to offer this new Texas location as part of the amazing natural facilities that Nature’s Classroom Institute uses.</p><ul><li>New, more comfortable dorm facilities with linens (including towels, sheets, blankets, pillows and pillowcases) on pillow-top mattresses will be provided for the students and chaperons</li><li>New environment for the students to explore during field group and class activities</li><li>Expanded dining hall availability to serve a larger variety of allergy and dietary restrictions</li><li>Increased flexibility with booking dates</li><li> A more central proximity to Dallas, Austin, Houston and San Antonio to allow us to serve more schools</li></ul>',
    openEnrollment: false,
    sidebarGeneralInfo: [
      { rank: 0, title: 'New Ulm Fact Sheet (PDF)', url: 'https://nciw.s3.amazonaws.com/documents/NCI_Wimberley_FactSheet.pdf', faName: 'file-pdf-o' },
      { rank: 1 },
      { rank: 2, title: 'Prepare for NCI', to: '/environmental/prepare', faName: 'check-square-o' },
      { rank: 3, title: 'Registration Portal', url: 'https://discovernci.org/dashboard', faName: 'clipboard' },
      { rank: 4, title: 'NCI Facebook Page', url: 'https://www.facebook.com/NaturesClassroomInstitute/', faName: 'facebook-official' },
      { rank: 5 },
      { rank: 6, title: 'Faculty & Staff', to: '/environmental/new-ulm-texas/faculty-staff', faName: 'users' }
    ]
  },
  { id: 5,
    ...
    type: 'ee',
    primaryContacts: [1],
    bannerImg: '//nciw.s3.amazonaws.com/discovernci_media/LakeGenevaBg.jpg',
    bgImg: 'https://nciw.s3.amazonaws.com/discovernci_media/bg3.jpg',
    ogImg: '//nciw.s3.amazonaws.com/discovernci_media/nci-og-lake-geneva.jpg',
    ogDescription: 'Lake Geneva is just under an hour and a half from downtown Chicago, and less than 1 hour from Milwaukee. Our Lake Geneva site sits on the shores of Geneva Lake with ample woodlands, wetlands and open fields to explore.',
    foodMenu: '//nciw.s3.amazonaws.com/discovernci_media/LakeGenevaNCI_FoodMenu.xlsx',
    sidebarContent: '<img src="https://nciw.s3.amazonaws.com/documents/lake-geneva/LakeGenevaStage.jpg" class="img-responsive img-rounded bottom-30" alt="presentation"><br /><img src="https://nciw.s3.amazonaws.com/documents/lake-geneva/LakeGenevaCommons.jpg" class="img-responsive img-rounded" alt="presentation">',
    streetAddress: 'W2655 South Street<br /> Lake Geneva, WI 53147',
    phone: '262-363-2815',
    body: "<p>Nature's Classroom Institute in Lake Geneva is just under an hour and a half from downtown Chicago, and less than 1 hour from Milwaukee. Our Lake Geneva site sits on the shores of Geneva Lake with ample woodlands, wetlands and open fields to explore. The property shares its boundary with Big Foot Beach State Park which offers amazing marshes and bogs.</p> <img src=\"https://nciw.s3.amazonaws.com/discovernci_media/LakeGeneva.jpg\" class=\"img-responsive img-rounded top-20 bottom-30\" /> <p>The Lake Geneva facility has modern accommodations mixed with an exciting learning environment. Housing is available for up to 112 students with comfortable sleeping quarters and ample bathroom facilities. The property is fully handicap accessible. Lake Geneva is fully winterized and offers the visiting school teachers their own private room with private bathroom as well as fully contained apartments which are available upon request. Directions to NCI - Lake Geneva (aka Lake Geneva Youth Camp).</p> <h3 class=\"bottom-30\">Dorm accommodations</h3> <div class=\"media\"><div class=\"media-left\"><img src=\"//nciw.s3.amazonaws.com/documents/lake-geneva/Maples.jpg\" width=\"128\" height=\"128\" alt=\"presentation\" class=\"img-rounded\"></div><div class=\"media-body\"><h4 class=\"media-heading\"><a href=\"https://nciw.s3.amazonaws.com/documents/lake-geneva/Maples-BOTH-Floors.-rev-10.15.pdf\">The Maples floor plan (PDF)</a></h4><p>An historic and wheelchair accessible lodging facility with room for up to 54 guests with semi-private baths.</p></div></div> <div class=\"top-30 media\"><div class=\"media-left\"><img src=\"https://nciw.s3.amazonaws.com/documents/lake-geneva/Birchwood.jpg\" width=\"128\" height=\"128\" alt=\"presentation\" class=\"img-rounded\"></div><div class=\"media-body\"><h4 class=\"media-heading\"><a href=\"https://nciw.s3.amazonaws.com/documents/lake-geneva/Birchwood-BOTH-Floors-rev-10.15.pdf\">Birchwood floor plan (PDF)</a></h4><p>A duplex style facility offering two wheelchair accessible rooms and capacity for 58 guests. There are 11 spaces with a varying capacity between 4-10 guests per room.</p></div></div>",
    openEnrollment: true,
    sidebarGeneralInfo: [
      { rank: 0, title: 'Lake Geneva Fact Sheet (PDF)', url: 'https://nciw.s3.amazonaws.com/documents/NCI_LakeGeneva_FactSheet.pdf', faName: 'file-pdf-o' },
      { rank: 1, title: 'Maples Room Assignment', url: 'https://nciw.s3.amazonaws.com/documents/lake-geneva/Maples-BOTH-Floors.-rev-10.15.pdf', faName: 'file-pdf-o' },
      { rank: 2, title: 'Birchwood Room Assignment', url: 'https://nciw.s3.amazonaws.com/documents/lake-geneva/Birchwood-BOTH-Floors-rev-10.15.pdf', faName: 'file-pdf-o' },
      { rank: 3 },
      { rank: 4, title: 'Prepare for NCI', to: '/environmental/prepare', faName: 'check-square-o' },
      { rank: 5, title: 'Registration Portal', url: 'https://discovernci.org/dashboard', faName: 'clipboard' },
      { rank: 6, title: 'Food Menu & Schedule', url: 'https://nciw.s3.amazonaws.com/discovernci_media/LakeGenevaNCI_FoodMenu.xlsx', faName: 'cutlery' },
      { rank: 7 },
      { rank: 8, title: 'Lake Geneva Facebook Page', url: 'https://www.facebook.com/NaturesClassroomInstituteWI/', faName: 'facebook-official' },
      { rank: 9, title: 'NCI Facebook Page', url: 'https://www.facebook.com/NaturesClassroomInstitute/', faName: 'facebook-official' },
      { rank: 10 },
      { rank: 11, title: 'Faculty & Staff', to: '/environmental/lake-geneva-wisconsin/faculty-staff', faName: 'users' }
    ]
  },
  { id: 6,
    name: 'Mukwonago, Wisconsin - Montessori School',
    ...
    ogImg: '//nciw.s3.amazonaws.com/discovernci_media/nci-og-lake-geneva.jpg',
    ogDescription: 'Lake Geneva is just under an hour and a half from downtown Chicago, and less than 1 hour from Milwaukee. Our Lake Geneva site sits on the shores of Geneva Lake with ample woodlands, wetlands and open fields to explore.',
    streetAddress: 'W336 S8455 Hwy E<br />PO Box 660<br />Mukwonago WI 53149',
    phone: '(262) 363-2815',
    body: ''
  }
];
