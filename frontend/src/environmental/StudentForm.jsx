...
import { Row, Col, Radio, Button, FormControl, FormGroup, ControlLabel, Checkbox } from 'react-bootstrap';
...
class StudentFormContainer extends React.Component {
  ...
  componentWillReceiveProps = (nextProps) => {
    // console.log('StudentForm nextProps: ', nextProps);
        ...
        {this.state.step !== 8 &&
          <span>
            ...
            <div className="step-bar">
              <ul>
                <li /* onClick={() => this.gotoStep(1)} */ className={this.state.step === 1 && 'active'}>Basic</li>
                <li /* onClick={() => this.gotoStep(2)} */ className={(this.state.step === 2 || this.state.step === 3) && 'active'}>Medical</li>
                <li /* onClick={() => this.gotoStep(4)} */ className={this.state.step === 4 && 'active'}>Allergies</li>
                <li /* onClick={() => this.gotoStep(5)} */ className={this.state.step === 5 && 'active'}>Medications</li>
                <li /* onClick={() => this.gotoStep(6)} */ className={this.state.step === 6 && 'active'}>Dietary</li>
              </ul>
            </div>
          </span>
        }
        ...
        {this.state.step === 7 &&
          <div className="form-step">
            ...
            <FormGroup style={{ background: '#fff6b5', padding: '10px 10px 0 10px', border: '1px solid #dfdfdf', borderRadius: 4 }}>
              ...
              <p className="help-block">
                I have read the medical authorization, waiver and release, and understand my rights by signing it and sign it voluntarily. <a href="https://nciw.s3.amazonaws.com/discovernci_media/waiver.pdf" target="_blank" rel="noopener noreferrer">View Waiver and Release of Liability Agreement</a>.
              </p>
            </FormGroup>
