...
class StudentDetailModalContainer extends React.Component {
  ...
  static propTypes = {
    showStudentDetail: PropTypes.bool.isRequired,
  ...
  render() {
    const student = this.props.studentProfile.student &&
      this.props.studentProfile.student;

    return (
      <Modal show={this.props.showStudentDetail} onHide={this.props.onHide} backdrop="static">
          ...
          <Modal.Body>
            ...
            <div style={{ borderTop: '1px solid #e4e4e4' }}>
              ...
              <ul style={{ listStyleType: 'none', margin: 0, padding: '0 0 0 15px' }}>
                ...
                <li>Weight: {student.medicalrecord && student.medicalrecord.weight} lbs</li>
              </ul>
            </div>
                      ...
                      <tbody>
                        {_.map(student.medicalrecord.medicationSet, medication => (
                          <tr key={medication.id}>
                            ...
                            <td>{medication.administrationTimes} {this.getMedTimeDisplay(medication.administrationTimes)}</td>
                            <td>{medication.note && <span title={medication.note}><FontAwesome name="sticky-note" /></span>}</td>
                          </tr>
                        ))}
                      </tbody>
                    </Table>
        ...
        <Modal.Footer>
          Last modified: <Moment fromNow>{student && student.modified}</Moment>
        </Modal.Footer>
      </Modal>
    );
  }
